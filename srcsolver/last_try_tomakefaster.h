...
namespace last_try_tomakefaster
{
...
struct SFIELD final
{
   ...
   bool Solve(char* result) noexcept
   {
      ...
      for (COUNTT k = 0; k < N_CELLS; ++k)
      {
         ...
         if (1 == optionsAmount) //CHANGE 2 [[unlikely]]
         {
      ...
      if (amount_established < N_CELLS)
      {
         ...
         for (COUNTT i = 0; i < N_OPTIONS; ++i)
         {
            ...
            if (vv == NOTFOUND)[[likely]] continue; //CHANGE 5
